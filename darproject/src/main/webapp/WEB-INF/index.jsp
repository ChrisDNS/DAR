...
<body id="page-top" class="index">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="intro-text">
                            <span class="name">PariSup'</span>
                            <span class="skills">Les études supérieures en un
                        clic !</span>
                        </div>
                    </div>
                </div>
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-circle" src="https://unsplash.it/500/500?image=836" alt="">
                </div>
                <div class="col-md-6">
                    <div class="p-5">
    ...
    <section class="success">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="img-circle" src="https://unsplash.it/500/500?image=452" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img class="img-circle" src="https://unsplash.it/500/500?image=453" alt="">
                </div>
                <div class="col-md-6">
                    <div class="p-5">
