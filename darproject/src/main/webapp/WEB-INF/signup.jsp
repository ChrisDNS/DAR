	...
	<div class="signupForm">
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="adress" placeholder="Entrer votre addresse">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-5" for="town">Ville:*</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="town" placeholder="Entrer votre ville">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-12">
					<label class="control-label col-sm-5" for="email">Anciennes et / ou récente(s) école(s) fréquentée(s):*</label>
					<div class="col-sm-11">
						<p>TODO</p>
					</div>
				</div>
